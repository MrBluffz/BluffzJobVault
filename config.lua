Config = {
  ...
  Notify = 'mythic_new',                          -- OPTIONS: 'esx', 'ns', 'mythic_old', 'mythic_new', 'chat', 'custom'. Adjust custom notification on line 82 of client.lua, change notification message on line 111
  Target = true,                                  -- true for fivem-target | false for ESX.ShowHelpNotification
